...
*/
var kicks = {};
kicks.brand = "Nike, not NikE"
kicks.color = "Colorful asf"
kicks.size = 12
kicks.price = 80
kicks.buy = function(){
    return "Now I i are coolest kid on block!"
}
console.log(kicks);
/* 
...
function printObj(sum){
  return sum.a + " + " + sum.b + " = " + sum.result;
}
...
function detectingTransmission(obj){
  ...
  return " yeah it's an automatic"
  }else{
    return "i like using 2 feet to drive."
  }
}
...
// addPassengers(stockCar, passengerList, passengerAges);
// console.log(stockCar); ** used to check code **
